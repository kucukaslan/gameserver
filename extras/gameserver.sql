...
--
-- Database: `gameserverapiimport`
--
CREATE DATABASE IF NOT EXISTS `gameserverapiimport` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `gameserverapiimport`;
